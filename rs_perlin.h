...
extern float cnoise2(float x, float y, int octaves, float persistence, float lacunarity);
extern float cnoise3(float x, float y, float z, int octaves, float persistence, float lacunarity);
#endif
